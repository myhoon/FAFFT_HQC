...
#define S2_GF216_NUMX32 48

extern const uint32_t s2_gf256_vec[S2_GF256_NUMX32*8];
extern const uint32_t s2_gf216_vec[S2_GF216_NUMX32*16];

#define S3_GF256_NUMX32 32
#define S3_GF216_NUMX32 32

extern const uint32_t s3_gf256_vec[S3_GF256_NUMX32*8];
extern const uint32_t s3_gf216_vec[S3_GF216_NUMX32*16];


#define S4_GF16_NUMX32 4
#define S4_GF256_NUMX32 60
